public class Board{
    ...
    public boolean canSelect(int x, int y){
    	...
    	if(pieceAt(x,y)!=null){
         ...
         /*the case for no piece at that place*/
    		...
    		else if((pieceAt(destination_x,destination_y)!=null) && pieceAt(destination_x,destination_y).hasCaptured() && validMove(destination_x,destination_y,x,y)) {
    			return true;
    		}
    		return false;
    	}
    ...
    public void endTurn(){
    	...
    	selected=false;
    	moved=false;
        if (pieceAt(destination_x,destination_y)!=null){
